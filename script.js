...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function clearTerminal() {
    ...
    loadAsciiArt("ascii_art/NS.txt", 235).then((ascii) => {
      ...
      welcome.innerHTML = `Welcome to Nikaansh Singh's Portfolio. Type <span class="command-highlight">help</span> to get started or type <span class="command-highlight">exit</span> or <span class="command-highlight">web</span> for the web version. 
